  ...
  return (
    <section className="py-24 lg:py-28 bg-brand-cream">
      <div className="max-w-6xl mx-auto px-4">
        <motion.div
          className="bg-white rounded-3xl shadow-lg border border-brand-green/5 overflow-hidden flex flex-col lg:flex-row"
          variants={scaleIn}
          initial="hidden"
          whileInView="visible"
        ...
        >
          ...
          <div className="flex-1 p-6 sm:p-10 lg:p-14">
            ...
            >
              <motion.h2
                className="text-2xl lg:text-3xl font-bold text-brand-green mb-3"
                variants={fadeInUp}
                transition={defaultTransition}
              >
